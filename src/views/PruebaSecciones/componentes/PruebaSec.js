...
function PruebaSec(props) {
    return (
        <>
            <section className="seccion">

                <div className="subseccion subseccion-azul">
                    
                </div>


                <div className="subseccion subseccion-verde">
                ...
                <div className="subseccion subseccion-roja">
                    {/*<img src='logo192.png' alt='foto seccion roja' className="imagenRoja" />*/}
                </div>
